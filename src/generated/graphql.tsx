...
export enum DistributionDefinitionTypes {
  ...
  MeanSd = 'MEAN_SD',
  /** Через среднее дискретное и стандартное отклонение */
  ...
  /** Через два процентиля 90 и 10 */
  TwoPercentilesP90P10 = 'TWO_PERCENTILES_P90_P10',
  /** Через два процентиля 99 и 1 */
  ...
  /** Через среднее и один процентиль 10*/
  MeanOnePercentileP10 = 'MEAN_ONE_PERCENTILE_P10',
  /** Через среднее и один процентиль 90 */
  MeanOnePercentileP90 = 'MEAN_ONE_PERCENTILE_P90',
  /** Через среднее дискретное и один процентиль 90 */
  MeanDiscretOnePercentileP90 = 'MEAN_DISCRETE_ONE_PERCENTILE_P90',
  /** Через среднее дискретное и один процентиль 95 */
  MeanDiscretOnePercentileP95 = 'MEAN_DISCRETE_ONE_PERCENTILE_P95',
  /** Через расположение и два процентиля 50 и 90 */
  LocationTwoPercentilesP50P90 = 'LOCATION_TWO_PERCENTILES_P50_P90',
  /** Через расположение и два процентиля 50 и 10 */
  ...
  /** Через расположение, логарифмическое среднее и один процентиль 90 */
  LocationLogmeanOnePercentileP90 = 'LOCATION_LOGMEAN_ONE_PERCENTILE_P90',
  /** Через расположение, логарифмическое среднее и один процентиль 10 */
  LocationLogmeanOnePercentileP10 = 'LOCATION_LOGMEAN_ONE_PERCENTILE_P10',
  /** Через расположение и два процентиля 90 и 10 */
  LocationTwoPercentilesP90P10 = 'LOCATION_TWO_PERCENTILES_P90_P10',
  /** Через расположение и два процентиля 90 и 50 */
...
// The file generated on: 25.06.2021
